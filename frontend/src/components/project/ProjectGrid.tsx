    ...
    <div className="bg-white w-full p-6">
        ...
        {projects.slice(0, 7).map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-col items-center text-center mb-4">
              <div
                className={`w-12 h-12 ${project.iconColor} rounded-xl flex items-center justify-center mb-3`}
              >
            ...
            <div className="mb-4">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div
                  ...
                  style={{
                    width: `${getProgressPercentage(project.tasks.completed, project.tasks.total)}%`,
                  }}
                ></div>
              </div>
            </div>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button className="w-8 h-8 rounded text-sm text-gray-600 hover:bg-gray-100">
            1
          </button>
          <button className="w-8 h-8 rounded text-sm bg-orange-500 text-white">
            2
          </button>
          <button className="w-8 h-8 rounded text-sm text-gray-600 hover:bg-gray-100">
            3
