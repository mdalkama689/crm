/*
  ...
  - The values [1-10,10-50,50-100,100+] on the enum `EmployeeRange` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."EmployeeRange_new" AS ENUM ('RANGE_1_10', 'RANGE_10_50', 'RANGE_50_100', 'RANGE_100_PLUS');
