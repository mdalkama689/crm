...
import { ChevronDown, Filter, Funnel, Grid2X2, Grid2x2, List, Rows2 } from "lucide-react"
...
<div
className="absolute top-[80px] left-[450px]"
>
  <Fix />
</div>
  ...
  return (
    ...
    <div className="flex items-center gap-4 bg-white p-2 rounded-lg border ">
      ...
      <div className="flex p-1">
        ...
        <Button className={`flex items-center gap-2 px-4 py-2 bg-transparent text-black hover:bg-purple-600 hover:text-white rounded-full cursor-pointer text-sm font-medium ${showProjectList && "bg-purple-500 text-white"}`}
