...
const Extra = () => {
 const [uppy] = useState(() => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-bold mb-4">File Uploader with Screen Capture</h2>
      <div className="mb-4 p-3 bg-yellow-100 border border-yellow-400 rounded">
        <p className="text-sm text-yellow-800">
          <strong>Note:</strong> Screen capture requires HTTPS in production. 
          Make sure your browser supports screen capture API and you grant necessary permissions.
        </p>
      </div>
      <Dashboard
        uppy={uppy}
