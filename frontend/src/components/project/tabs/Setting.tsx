...
const Setting = () => {
  ...
  return (
   ...
   {project?.description ? 
   (
         <Editor content={content} setContent={setContent} setDelta={setDelta} />
   ) :
    (
           <Editor content={content} setContent={setContent} setDelta={setDelta} />
    )}
  ...
  <div>
    <p className="text-sm font-semibold text-gray-800">General Information</p>
...
<div className="flex items-start gap-3 p-4 rounded-2xl border border-gray-200 bg-white shadow-sm">
  ...
  <div>
    <p className="text-sm font-semibold text-gray-800">Account & Apps</p>
    <p className="text-xs text-gray-500">Connect tools and services</p>
  </div>
</div>
...
<div className="flex items-start gap-3 p-4 rounded-2xl border border-gray-200 bg-white shadow-sm">
  ...
  <div>
    ...
    <p className="text-xs text-gray-500">Set your email notification</p>
  </div>
</div>
...
<Button className="flex  bg-transparent mt-4 items-center gap-6 w-full px-14 cursor-pointer py-9 rounded-lg border border-gray-200 hover:bg-gray-50 transition">
  ...
  <div className="flex flex-col text-left">
    ...
    <p className="text-xs text-gray-500">Hide & disable current project</p>
  </div>
</Button>
